...
type QuerySceneDo struct {
	...
	CreatedAt   int64   `gorm:"column:created_at;not null;comment:创建时间"`
	UpdatedAt   int64   `gorm:"column:updated_at;not null;comment:更新时间"`
	DeletedAt   *int64  `gorm:"column:deleted_at;index:idx_deleted_at;comment:软删除时间"`
}
