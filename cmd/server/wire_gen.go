...
func wireApp(confServer *conf.Server, confData *conf.Data, logger log.Logger) (*kratos.App, func(), error) {
	...
	v := route.RegisterHttpService(confData, greeterApiService, foDashboardService, doDashboardService, etlService, alertService, issueReportService, reconcileService)
