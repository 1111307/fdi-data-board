...
func wireApp(confServer *conf.Server, confData *conf.Data, logger log.Logger) (*kratos.App, func(), error) {
	...
	datasourceRepo := data.NewDatasourceRepo(dataData)
	datasourceUseCase := biz.NewDatasourceUseCase(datasourceRepo)
	datasourceService := service.NewDatasourceService(datasourceUseCase)
	sceneGroupRepo := data.NewSceneGroupRepo(dataData)
	sceneGroupUseCase := biz.NewSceneGroupUseCase(sceneGroupRepo)
	sceneGroupService := service.NewSceneGroupService(sceneGroupUseCase)
	...
	v := route.RegisterHttpService(confData, greeterApiService, querySceneService, datasourceService, sceneGroupService, foDashboardService, doDashboardService, etlService)
